...
import 'package:get/get.dart';
import 'package:getx_app_one/controllers/detail_page_controller.dart';
            ...
            child: Stack(
                children: [
                  Positioned(top:50, left:10,child: IconButton(
                    onPressed: ()=> Get.to(()=> const ContentPage()), icon: const Icon(Icons.home_rounded,color: Colors.white,),
                  )),
                  Positioned(
                    top: 120,
                    left: 0,
                  ...
                  //images
                  Stack(
                        children:[for(int i=0; i<images.length; i++)
                          Positioned(
                              top:590,
